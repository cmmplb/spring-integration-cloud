DROP DATABASE IF EXISTS `seata_eureka`;

CREATE DATABASE `seata_eureka` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO `user_user` (`account`, `money`, `name`)
