package com.cmmplb.cmmondb.config;//package com.cmmplb.cmmondb.config;
//
...
//
//    private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(SeataRMRequestFilter.class);
//
//    /**
//     * 给每次线程请求绑定一个XID
//     * @param request
...
//        String currentXID = request.getHeader(SeataAutoConfiguration.SEATA_XID);
