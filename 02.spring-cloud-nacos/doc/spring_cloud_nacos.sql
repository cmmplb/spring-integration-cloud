...
-- ----------------------------
BEGIN;
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`) VALUES (1, 'spring-cloud-nacos-client.yaml', 'DEFAULT_GROUP', 'nacos:\n  name:\n    张三', '17659acd2e4ebd19b49891b201678c06', '2024-06-28 08:11:27', '2024-06-28 08:11:27', NULL, '10.210.63.207', '', '', NULL, NULL, NULL, 'yaml', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`) VALUES (0, 1, 'spring-cloud-nacos-client.yaml', 'DEFAULT_GROUP', '', 'nacos:\n  name:\n    张三', '17659acd2e4ebd19b49891b201678c06', '2024-06-28 16:11:26', '2024-06-28 08:11:27', NULL, '10.210.63.207', 'I', '');
COMMIT;
