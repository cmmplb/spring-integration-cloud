package com.cmmplb.security.oauth2.starter.provider.granter.mobile;
...
import com.cmmplb.security.oauth2.starter.common.exceptions.MobileCodeException;
...
public class MobileAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Object cacheCode = redisService.get(CacheConstants.SMS_CODE_PREFIX + mobile);
